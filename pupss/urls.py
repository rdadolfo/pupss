...
from pupss.views import dashboard_download_view, dashboard_rows_api, landing, dashboard, custom_logout, hatedetector, process_view, download_view, preview_columns_view, dashboard_data_view
...
urlpatterns = [
    ...
    path('dashboard/download/', dashboard_download_view, name='dashboard_download')
]
